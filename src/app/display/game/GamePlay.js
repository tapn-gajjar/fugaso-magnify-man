...
export default class GamePlay extends GameBase {
    ...
    _waitForBet() {
        ...
        this._aBgIdle = OMY.Omy.add.actorJson(this._flyCanvas, this._jsonBgSpine);
        this._aBgIdle.gotoAndPlay(0, false, this._aBgIdle.json["start"]);
        this._aBgIdle.addSpineEvent(this._onBGRunEnd, this, false);
    ...
    _prepareForPlay() {
        ...
        if (!this._aSpine) {
            ...
            this._aBgIdle.removeSpineEvent(this._onBGRunEnd, this);
    ...
    /**     * @private     */
    _onBGRunEnd(spine, event) {
        if (event.data.name === "bg_end")
            this._aBgIdle.gotoAndPlay(0, false, this._aBgIdle.json["start"]);
    }
